...
// Software module (Initiator) - sends commands to the hardware
SC_MODULE(Software) {
    ...
    // Function to send commands to the hardware
    ...
    void send_command(int cmd, int x, int y, sc_time &delay) {
        ...
        // Print the result
        std::cout << "Command: " << cmd_to_string(cmd) << ", Result: " << data[0] << std::endl;
    }
